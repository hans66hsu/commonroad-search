...
public:
  ...
  static fcl::Transform3<FCL_PRECISION>
  ...
  static fcl::Transform3<FCL_PRECISION>
  fcl_get_3d_rotation_translation(const Eigen::Vector2d &pos,
                                  const Eigen::Vector2d &x_axis) {
  ...
  static fcl::Transform3<FCL_PRECISION>
  fcl_get_3d_rotation_translation(const Eigen::Vector2d &pos, double angle) {
    fcl::Transform3<FCL_PRECISION> trans = fcl_get_3d_translation(pos);
    trans.rotate(fcl::AngleAxis<FCL_PRECISION>(

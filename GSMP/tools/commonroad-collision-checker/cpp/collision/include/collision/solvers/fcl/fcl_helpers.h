...
namespace solvers {
namespace solverFCL {
inline FCL_COLLISION_ENTITY_TYPE
get_object_fcl_entity_type(const CollisionObject *obj2) {
...
inline const FCLCollisionObjectGroup *
get_fcl_object_group_ptr(const CollisionObject *obj) {
...
inline const FCLCollisionObject *
get_fcl_object_ptr(const CollisionObject *obj) {
  const CollisionObjectEx *obj_ex = static_cast<const CollisionObjectEx *>(obj);
  if (!obj_ex)
    return nullptr;
  SolverEntity_FCL *fcl_entity;
...
inline FCL_COLLISION_ENTITY_TYPE
get_object_fcl_entity_type(CollisionObjectConstPtr obj2,
                           SolverEntity_FCL *&req_entity) {

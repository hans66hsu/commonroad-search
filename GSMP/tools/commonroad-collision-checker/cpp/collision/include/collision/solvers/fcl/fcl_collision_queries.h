/*
 * fcl_primitive_collision_tests.h
 *
...
inline fcl::Transform3<FCL_PRECISION>
fcl_get_3d_translation(const Eigen::Vector2d &pos) {
...
inline bool
fcl_generic_collisionDetection(const FCLCollisionObjectGroup &group_first,
                               const FCLCollisionObject &obj_second,
...
inline int
fcl_group_overlap(const FCLCollisionObjectGroup &group_first,

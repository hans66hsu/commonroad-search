...
PrimitiveCollisionCheckerPtr
CollisionChecker::windowQueryPrimitive(const RectangleAABB &aabb) const {
...
*/
CollisionCheckerPtr
CollisionChecker::windowQuery(const RectangleAABB &aabb) const {
...
CollisionCheckerConstPtr
CollisionChecker::deserialize(std::istream &input_stream) {

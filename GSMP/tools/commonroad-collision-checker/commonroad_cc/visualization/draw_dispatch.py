...
import commonroad_cc.visualization.pycrcc


def _create_drawers_dict_pycrcc():
    draw_func_pycrcc = {}
    if 'commonroad_cc.visualization.pycrcc' in sys.modules.keys():
        draw_func_pycrcc.update(commonroad_cc.visualization.pycrcc.draw_func_dict)
...
def _create_default_draw_params_pycrcc():
    ...
    if 'commonroad_cc.visualization.pycrcc' in sys.modules.keys():
        draw_params.update(commonroad_cc.visualization.pycrcc.create_default_draw_params())
    return draw_params

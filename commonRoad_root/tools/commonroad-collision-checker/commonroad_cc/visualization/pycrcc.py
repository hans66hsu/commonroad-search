...
def draw_collision_point(obj, plot_limits, ax, draw_params, draw_func, handles, call_stack):
    try:
        facecolor = commonroad_cc.visualization.draw_dispatch._retrieve_alternate_value(
            draw_params, call_stack,
            ('collision', 'point', 'facecolor'),
            ('collision', 'facecolor'))
        zorder = commonroad_cc.visualization.draw_dispatch._retrieve_alternate_value(
            draw_params, call_stack,
...
def draw_collision_rectaabb(obj, plot_limits, ax, draw_params, draw_func, handles, call_stack):
    try:
        facecolor = commonroad_cc.visualization.draw_dispatch._retrieve_alternate_value(
            ...
            ('collision', 'facecolor'))
        edgecolor = commonroad_cc.visualization.draw_dispatch._retrieve_alternate_value(
            draw_params, call_stack,
...
def draw_collision_timevariantcollisionobject(obj, plot_limits, ax, draw_params, draw_func, handles, call_stack):
    ...
    for i in range(obj.time_start_idx(), obj.time_end_idx() + 1):
        ...
        if "time_to_color" in draw_params.keys():
            ...
            commonroad_cc.visualization.draw_dispatch.draw_object(obj, plot_limits, ax, draw_params,
                                                         draw_func, handles, call_stack)
        else:
            commonroad_cc.visualization.draw_dispatch.draw_object(tmp, plot_limits, ax, draw_params,
                                                         draw_func, handles, call_stack)
...
def draw_collision_shapegroup(obj, plot_limits, ax, draw_params, draw_func, handles, call_stack):
    ...
    for o in obj.unpack():
        commonroad_cc.visualization.draw_dispatch.draw_object(o, plot_limits, ax, draw_params,
                                                     draw_func, handles, call_stack)
...
def draw_collision_polygon(obj, plot_limits, ax, draw_params, draw_func, handles, call_stack):
    try:
        ...
        zorder = commonroad_cc.visualization.draw_dispatch._retrieve_alternate_value(
            ...
            ('collision', 'zorder'))
        draw_mesh = commonroad_cc.visualization.draw_dispatch._retrieve_value(
            draw_params, call_stack,

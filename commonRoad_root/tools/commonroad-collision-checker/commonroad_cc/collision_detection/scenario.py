...
import commonroad_cc.collision_detection.pycrcc_collision_dispatch
...
def create_collision_checker_scenario(scenario: Scenario, params=None, collision_object_func=None):
    ...
    for co in scenario.dynamic_obstacles:
        cc.add_collision_object(commonroad_cc.collision_detection.pycrcc_collision_dispatch.create_collision_object(
...
def create_collision_object_shape_group(shape_group, params=None, collision_object_func=None):
    ...
    for shape in shape_group.shapes:
        sg.add_shape(commonroad_cc.collision_detection.pycrcc_collision_dispatch.create_collision_object(
...
def create_collision_object_static_obstacle(static_obstacle, params=None, collision_object_func=None):
    ...
    return commonroad_cc.collision_detection.pycrcc_collision_dispatch.create_collision_object(
...
def create_collision_object_dynamic_obstacle(dynamic_obstacle, params=None, collision_object_func=None):
    ...
    tvo.append_obstacle(commonroad_cc.collision_detection.pycrcc_collision_dispatch.create_collision_object(

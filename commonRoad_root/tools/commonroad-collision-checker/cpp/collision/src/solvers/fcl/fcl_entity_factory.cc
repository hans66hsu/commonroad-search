...
namespace solvers {
namespace solverFCL {
SolverEntity_FCL *createFCLSolverEntity(CollisionObject *obj, ISolverEntity_FCL *entity) {
  switch (entity->getFclEntityType()) {
    case COLLISION_ENTITY_TYPE_FCL_OBJECTGROUP:
      return new FCLCollisionObjectGroup((static_cast<CollisionObjectEx *>(obj))->getContainerInterface(),
                                         obj,
                                         static_cast<collision::IFCLCollisionObjectGroup *>(entity));
      break;
    case COLLISION_ENTITY_TYPE_FCL_OBJECT:
      return new FCLCollisionObject(obj,
                                    static_cast<collision::IFCLCollisionObject *>(entity));
      break;

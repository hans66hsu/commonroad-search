...
PrimitiveCollisionChecker::windowQuery(const RectangleAABB &aabb) const {
...
PrimitiveCollisionCheckerPtr
PrimitiveCollisionChecker::timeSlice(int time_idx) const {
...
std::vector<CollisionObjectConstPtr>
PrimitiveCollisionChecker::getObstacles() const {
